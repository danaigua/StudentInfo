...
<script type="text/javascript">
	function dataDicDelete(ddId){
		if(confirm("确定要删除这条数据字典吗?")){
			$.post("dataDicDelete",{ddId:ddId},
					function(result){
						alert("删除成功！");
						window.location.href="${pageContext.request.contextPath}/dataDicList";
					}
			);
		}
	}
...
<div class="data_list">
	<div class="search_content">
		<form action="${pageContext.request.contextPath}/dataDicList">
		...
		<button class="btn btn-mini btn-primary" type="button" style="float: right;margin-bottom: 5px;" onclick="javascript:window.location='dataDicPreSave'">添加数据类别</button>
	</div>
