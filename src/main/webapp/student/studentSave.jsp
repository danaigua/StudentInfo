...
<div class="data_list">
	<div class="data_content">
		<form action="studentSave" method="post" onsubmit="return checkForm()" enctype="multipart/form-data">
		<table width="80%" align="center">
			<tr>
				<td><label>学号：</label></td>
				<td><input type="text" id="stuNum" name="student.stuNum" value="${student.stuNum}"/></td>
				<td>&nbsp;</td>
